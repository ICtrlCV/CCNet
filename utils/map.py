...
def get_map(min_overlap, draw_plot=False, score_threhold=0.5, path="../results"):
    ...
    # gt_path = f"{path}/ground_truth"
    # dr_path = f"{path}/detection_results"
    # img_path = f"{path}/images_optional"
    # temp_files_path = f"{path}/.temp_files"
    results_files_path = f"{path}/voc_eval_{min_overlap}"
    ...
    if len(ground_truth_files_list) == 0:
        error("Error: No ground_truth files found!")
...
def get_coco_map(class_names, save_path):
    gt_path = os.path.join(save_path, "ground_truth")
    dr_path = os.path.join(save_path, "detection_results")
    coco_path = os.path.join(save_path, "coco_eval")
    # gt_path = f"{save_path}/ground_truth"
    # dr_path = f"{save_path}/detection_results"
    # coco_path = f"{save_path}/coco_eval"
